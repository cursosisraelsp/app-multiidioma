package com.example.multiidioma.ui.screens.centros.igfae_andre.igfaeMiniScreens.igfaeMiniScreen26.contentIgfaeMiniScreen26
...
@Composable
fun contentIgfaeMiniScreen26Box2(data: MiniScreenData){
    Column(
        modifier = Modifier
            .fillMaxSize()
