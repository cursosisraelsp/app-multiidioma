package com.example.multiidioma.ui.screens.institutes.iarcus_andre.iarcusMiniScreens.iarcusMiniScreen20.contentIarcusMiniScreen20
...
@Composable
fun contentIarcusMiniScreen20Box2(data: MiniScreenData){
    Column(
        modifier = Modifier
            .fillMaxSize()
