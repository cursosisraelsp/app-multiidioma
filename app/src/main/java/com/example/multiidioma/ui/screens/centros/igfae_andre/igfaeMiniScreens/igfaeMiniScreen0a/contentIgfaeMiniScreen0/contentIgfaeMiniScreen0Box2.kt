package com.example.multiidioma.ui.screens.centros.igfae_andre.igfaeMiniScreens.igfaeMiniScreen0a.contentIgfaeMiniScreen0
...
@Composable
fun contentIgfaeMiniScreen0Box2(data: MiniScreenData){
    Column(
        modifier = Modifier
            .fillMaxSize()
