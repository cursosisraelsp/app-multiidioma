package com.example.multiidioma.ui.screens.centros.cretus_andre.cretusMiniScreens.cretusMiniScreen25i.contentCretusMiniScreen25
...
@Composable
fun contentCretusMiniScreen25Box2(data: MiniScreenData){
    Column(
        modifier = Modifier
            .fillMaxSize()
