package com.example.multiidioma.ui.screens.centros.igfae_andre.igfaeMiniScreens.igfaeMiniScreen25.contentIgfaeMiniScreen25
...
@Composable
fun contentIgfaeMiniScreen25Box2(data: MiniScreenData){
    Column(
        modifier = Modifier
            .fillMaxSize()
