package com.example.multiidioma.ui.screens.centros.igfae_andre.igfaeMiniScreens.igfaeMiniScreen27.contentIgfaeMiniScreen27
...
@Composable
fun contentIgfaeMiniScreen27Box2(data: MiniScreenData){
    Column(
        modifier = Modifier
            .fillMaxSize()
