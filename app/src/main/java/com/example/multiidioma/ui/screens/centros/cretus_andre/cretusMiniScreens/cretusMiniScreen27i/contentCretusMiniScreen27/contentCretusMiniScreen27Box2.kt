package com.example.multiidioma.ui.screens.centros.cretus_andre.cretusMiniScreens.cretusMiniScreen27i.contentCretusMiniScreen27
...
@Composable
fun contentCretusMiniScreen27Box2(data: MiniScreenData){
    Column(
        modifier = Modifier
            .fillMaxSize()
