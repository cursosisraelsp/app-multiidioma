package com.example.multiidioma.ui.screens.ciqus.ciqusMiniScreens.CiqusMiniScreen7.contentCiqusMiniScreen7
...
@Composable
fun contentCiqusMiniScreen7TitleText(data: MiniScreenData) {
    ...
    Column(
        ...
        AppText(data, estilosTextos, index = 3)
