package com.example.multiidioma.ui.screens.institutes.iarcus_andre.iarcusMiniScreens.iarcusMiniScreen21.contentIarcusMiniScreen21
...
@Composable
fun contentIarcusMiniScreen21Box2(data: MiniScreenData){
    Column(
        modifier = Modifier
            .fillMaxSize()
