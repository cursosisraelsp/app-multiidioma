package com.example.multiidioma.ui.screens.centros.igfae_andre.igfaeMiniScreens.igfaeMiniScreen24.contentIgfaeMiniScreen24
...
@Composable
fun contentIgfaeMiniScreen24Box2(data: MiniScreenData){
    Column(
        modifier = Modifier
            .fillMaxSize()
