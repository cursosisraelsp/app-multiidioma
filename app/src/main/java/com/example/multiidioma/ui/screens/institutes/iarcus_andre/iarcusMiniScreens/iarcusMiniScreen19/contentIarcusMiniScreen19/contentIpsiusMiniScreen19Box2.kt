package com.example.multiidioma.ui.screens.institutes.iarcus_andre.iarcusMiniScreens.iarcusMiniScreen19.contentIarcusMiniScreen19
...
@Composable
fun contentIarcusMiniScreen19Box2(data: MiniScreenData){
    Column(
        modifier = Modifier
            .fillMaxSize()
