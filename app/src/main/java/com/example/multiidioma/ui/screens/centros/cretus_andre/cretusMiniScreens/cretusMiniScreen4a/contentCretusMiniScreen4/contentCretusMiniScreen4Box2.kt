package com.example.multiidioma.ui.screens.centros.cretus_andre.cretusMiniScreens.cretusMiniScreen4a.contentCretusMiniScreen4
...
@Composable
fun contentCretusMiniScreen4Box2(data: MiniScreenData){
    Column(
        modifier = Modifier
            .fillMaxSize()
