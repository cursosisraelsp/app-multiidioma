package com.example.multiidioma.ui.screens.centros.igfae_andre.igfaeMiniScreens.igfaeMiniScreen23.contentIgfaeMiniScreen23
...
@Composable
fun contentIgfaeMiniScreen23Box2(data: MiniScreenData){
    Column(
        modifier = Modifier
            .fillMaxSize()
