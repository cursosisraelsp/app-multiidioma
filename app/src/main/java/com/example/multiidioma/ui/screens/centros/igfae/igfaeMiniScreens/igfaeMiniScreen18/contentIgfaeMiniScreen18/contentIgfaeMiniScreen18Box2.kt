package com.example.multiidioma.ui.screens.centros.igfae.igfaeMiniScreens.igfaeMiniScreen18.contentIgfaeMiniScreen18
...
@Composable
fun contentIgfaeMiniScreen18Box2(data: MiniScreenData){
    Column(
        modifier = Modifier
            .fillMaxSize()
