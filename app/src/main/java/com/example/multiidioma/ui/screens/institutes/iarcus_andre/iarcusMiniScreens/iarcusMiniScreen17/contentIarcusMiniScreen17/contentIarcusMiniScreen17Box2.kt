package com.example.multiidioma.ui.screens.institutes.iarcus_andre.iarcusMiniScreens.iarcusMiniScreen17.contentIarcusMiniScreen17
...
@Composable
fun contentIarcusMiniScreen17Box2(data: MiniScreenData){
    Column(
        modifier = Modifier
            .fillMaxSize()
