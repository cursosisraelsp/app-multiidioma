package com.example.multiidioma.ui.screens.centros.cretus_andre.cretusMiniScreens.cretusMiniScreen31i.contentCretusMiniScreen31
...
@Composable
fun contentCretusMiniScreen31Box2(data: MiniScreenData){
    Column(
        modifier = Modifier
            .fillMaxSize()
