package com.example.multiidioma.ui.screens.institutes.iarcus_andre.iarcusMiniScreens.iarcusMiniScreen18.contentIpsiusMiniScreen18
...
@Composable
fun contentIpsiusMiniScreen18Box2(data: MiniScreenData){
    Column(
        modifier = Modifier
            .fillMaxSize()
