...
@Composable
fun contentInciforMiniScreen22Box2(data: MiniScreenData) {
    ...
    Column(
        ...
        TextTitleMedium(data, index = 0, textAlign = TextAlign.Center, color = Color.Black) //Titulo 1

        TextTitleMediumRegular(data, index = 1, textAlign = TextAlign.Center, color = Color.Black) //Titulo 2
        ...
        TextBodyMedium(data, index = 2, textAlign = TextAlign.Center,color = Color.Black)
        Spacer(modifier = Modifier.height(25.dp))
    }
}