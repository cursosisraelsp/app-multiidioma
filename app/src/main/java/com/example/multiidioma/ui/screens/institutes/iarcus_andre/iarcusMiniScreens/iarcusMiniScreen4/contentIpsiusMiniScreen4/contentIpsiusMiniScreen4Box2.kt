package com.example.multiidioma.ui.screens.institutes.iarcus_andre.iarcusMiniScreens.iarcusMiniScreen4.contentIpsiusMiniScreen4
...
@Composable
fun contentIpsiusMiniScreen4Box2(data: MiniScreenData){
    Column(
        modifier = Modifier
            .fillMaxSize()
