package com.example.multiidioma.ui.screens.institutes.iarcus_andre.iarcusMiniScreens.iarcusMiniScreen4.contentIarcusMiniScreen4
...
@Composable
fun contentIarcusMiniScreen4Box2(data: MiniScreenData){
    Column(
        modifier = Modifier
            .fillMaxSize()
