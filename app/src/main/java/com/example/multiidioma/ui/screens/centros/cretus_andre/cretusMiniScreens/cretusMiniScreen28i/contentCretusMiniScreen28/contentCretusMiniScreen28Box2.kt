package com.example.multiidioma.ui.screens.centros.cretus_andre.cretusMiniScreens.cretusMiniScreen28i.contentCretusMiniScreen28
...
@Composable
fun contentCretusMiniScreen28Box2(data: MiniScreenData){
    Column(
        modifier = Modifier
            .fillMaxSize()
