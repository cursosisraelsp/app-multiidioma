...
@Composable
fun contentCiqusMiniScreen8Box2(data: MiniScreenData, offset: Int, listState: LazyListState, itemIndex: Int) {
    ...
    Column(
        ...
        Column(
           ...
           LottieScrollWithOffsetComponent(debuxoLottie = R.raw.ciqus_anim_01, listState, itemIndex)
