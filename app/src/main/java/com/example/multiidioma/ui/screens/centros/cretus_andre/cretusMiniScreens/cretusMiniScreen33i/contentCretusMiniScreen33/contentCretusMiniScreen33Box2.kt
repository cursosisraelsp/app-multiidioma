package com.example.multiidioma.ui.screens.centros.cretus_andre.cretusMiniScreens.cretusMiniScreen33i.contentCretusMiniScreen33
...
@Composable
fun contentCretusMiniScreen33Box2(data: MiniScreenData){
    Column(
        modifier = Modifier
            .fillMaxSize()
