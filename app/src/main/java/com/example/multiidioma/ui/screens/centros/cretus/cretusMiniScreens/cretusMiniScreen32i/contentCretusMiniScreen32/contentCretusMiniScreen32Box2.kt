package com.example.multiidioma.ui.screens.centros.cretus.cretusMiniScreens.cretusMiniScreen32i.contentCretusMiniScreen32
...
@Composable
fun contentCretusMiniScreen32Box2(data: MiniScreenData){
    Column(
        modifier = Modifier
            .fillMaxSize()
