package com.example.multiidioma.ui.screens.centros.cretus_andre.cretusMiniScreens.cretusMiniScreen5.contentIpsiusMiniScreen5
...
@Composable
fun contentIpsiusMiniScreen5Box2(data: MiniScreenData){
    Column(
        modifier = Modifier
            .fillMaxSize()
