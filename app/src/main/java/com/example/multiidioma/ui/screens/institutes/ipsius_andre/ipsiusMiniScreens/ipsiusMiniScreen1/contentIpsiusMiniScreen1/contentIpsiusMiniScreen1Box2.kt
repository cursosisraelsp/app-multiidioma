package com.example.multiidioma.ui.screens.institutes.ipsius_andre.ipsiusMiniScreens.ipsiusMiniScreen1.contentIpsiusMiniScreen1
...
@Composable
fun contentIpsiusMiniScreen1Box2(data: MiniScreenData, listState: LazyListState,
                                 itemIndex: Int,) {
    Box(modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            LottieScrollWithOffsetComponent(
                debuxoLottie = R.raw.ipsius_anim_01,
                listState = listState,
                itemIndex = itemIndex,
